...
A major focus of my current work is the development of physics–AI hybrid frameworks that combine urban climate models with data-driven methods. By addressing parameter uncertainty and model-form uncertainty, these approaches seek to improve prediction accuracy while maintaining physical interpretability. This research contributes to next-generation urban environmental modeling tools that are both robust and scalable.
...
My earlier research focused on building energy systems and sustainable building technologies. This work investigated the performance of building-integrated photovoltaic (BIPV) systems and optimization-based approaches for improving building energy efficiency across different climate contexts.

**Related publications**

* Multi-criteria performance assessment for semi-transparent photovoltaic windows in different climate contexts (*Sustainability*, 2021)
